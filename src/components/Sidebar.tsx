        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Product Dropdown --> */}
              <SidebarLinkGroup
                activeCondition={pathname.includes('promosyon')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* <!-- Waiter Dropdown End --> */}
              <SidebarLinkGroup activeCondition={pathname.includes('waiter')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
